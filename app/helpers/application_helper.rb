    ...
    <article data-article="" data-format="1" data-title="'+"#{country} #{section}"+'" data-tag-context="/tag/Country Information">
      <section class="body">
        ...
        <div class="layout content">
          <div id="product-bar" style="display:block; width:1px; height:1px; float:right; overflow: visible;"><a href="'+information_edit_url(host: 'contribute.worldstartupwiki.org', country: country, page: section)+'" class="toolbar-button action edit-page" style="color: #ffffff; width: 100px;">Edit Page</a></div>
